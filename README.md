...
How is spend trending across quarters?
How many POs were cancelled — and what did that cost us?
...
PO Data — 120 rows of Purchase Order records including supplier, category, quantity, unit price, total amount, order date, delivery date, status, month and quarter
Dashboard — KPI summary cards, supplier spend table, category breakdown, quarterly analysis, bar chart and pie chart
...
Dashboard design — KPI cards, summary tables, bar chart, pie chart
Excel — data formatting, conditional colour coding, number formats, charts
Python (pandas + openpyxl) — used to generate the dataset and build the workbook programmatically
...
Spend is relatively even across Q1–Q3, with a slight dip in Q4
...
Next Steps:
 ...
 Connect to a live Google Sheet for real-time updates
